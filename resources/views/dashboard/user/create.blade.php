...
@section('content')
     ...
     <form action="/dashboard/user" method="post" class="row g-3 col-lg-8">
          @csrf
          <div class="col-md-6">
          ...
          <div class="col-md-6">
               ...
               <input type="text" class="form-control @error('kode_member') is-invalid @enderror" name="kode_member" id="kode_member" value="{{ old('kode_member') }}" required>
               @error('kode_member')
                    <div class="invalid-feedback">
                         <i class="bx bx-radio-circle"></i>
                         {{ $message }}
